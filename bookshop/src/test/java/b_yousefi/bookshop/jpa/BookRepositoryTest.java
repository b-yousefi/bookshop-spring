...
public class BookRepositoryTest extends DataTest {
    ...
    public void findByAuthors_Id() {
        ...
        assertThat(getBookRepository().findByAuthors_Id(book.getAuthors().iterator().next().getId(), sortedByName)).hasSize(1);
    }
    ...
    public void findAllByPublication_Id() {
        Pageable sortedByName =
                PageRequest.of(0, 3, Sort.by("name"));
        assertThat(getBookRepository().findAllByPublication_Id(book.getPublication().getId(), sortedByName)).hasSize(1);
    }
    ...
    public void findByCategories_Id() {
        Pageable sortedByName =
                PageRequest.of(0, 3, Sort.by("name"));
        assertThat(book.getCategories().iterator().hasNext());
        assertThat(getBookRepository().findByCategories_Id(book.getCategories().iterator().next().getId(), sortedByName)).hasSize(1);
    }
    ...
    void findByPublication_Id() {
        Pageable sortedByName =
                PageRequest.of(0, 3, Sort.by("name"));
        assertThat(getBookRepository().findByPublication_Ids(List.of(book.getPublication().getId()), sortedByName)).hasSize(1);
    }
    ...
    void findByAuthor_Ids_when_null_return_all() {
        Pageable sortedByName =
                PageRequest.of(0, 3, Sort.by("name"));
        assertThat(book.getAuthors().iterator().hasNext());
    ...
    void filter_with_authors_and_publication_category() {
        ...
        assertThat(getBookRepository().filter(List.of(1L), List.of(2L, 4L), List.of(1L, 2L), sortedByName)).hasSize(2);
    }
    ...
    public void remove_book() {
        ...
        assertThat(getBookRepository().findAll()).hasSize(0);
        assertThat(getPublicationRepository().findAll()).hasSize(1);
        assertThat(getAuthorRepository().findAll()).hasSize(1);
        assertThat(getCategoryRepository().findAll()).hasSize(1);
    }
